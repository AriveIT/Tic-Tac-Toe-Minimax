...
*time passed on first execution measured using Time.time(). First execution is measured because following executions are too quick to be measured by Time.time()